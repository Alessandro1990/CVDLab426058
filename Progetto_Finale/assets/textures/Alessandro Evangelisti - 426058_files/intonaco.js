...
var bcGeometry = new THREE.PlaneGeometry(8.6,1);
...
for(i=1; i<6; i++){ 
	var clone = bc.clone();
	clone.position.set(7.2,2.8*(i+1)+k*i,6.6);
    scene.add(clone); 
}  
for(i=1; i<6; i++){ 
	var clone = bc.clone();
	clone.position.set(7.2,2.8*(i+1)+k*i-2,6.6);
    scene.add(clone); 
}
bc2Geometry = new THREE.PlaneGeometry(0.8,2);
bc2 = new THREE.Mesh(bc2Geometry,bcMaterial);
for(i=1; i<6; i++){ 
	var clone = bc2.clone();
	clone.position.set(3.3,2.8*(i+1)+k*i-1,6.6);
    scene.add(clone); 
}
for(i=1; i<6; i++){ 
	var clone = bc2.clone();
	clone.position.set(7.4,2.8*(i+1)+k*i-1,6.6);
    scene.add(clone); 
}
for(i=1; i<6; i++){ 
	var clone = bc2.clone();
	clone.position.set(11.2,2.8*(i+1)+k*i-1,6.6);
    scene.add(clone); 
}
bc3Geometry = new THREE.PlaneGeometry(1.1,2);
bc3 = new THREE.Mesh(bc3Geometry,bcMaterial);
for(i=1; i<6; i++){ 
	var clone = bc3.clone();
	clone.position.set(5,2.8*(i+1)+k*i-1,6.6);
    scene.add(clone); 
}
for(i=1; i<6; i++){ 
	var clone = bc3.clone();
	clone.position.set(9.4,2.8*(i+1)+k*i-1,6.6);
    scene.add(clone); 
}
bc4Geometry = new THREE.PlaneGeometry(0.6,2);
bc4 = new THREE.Mesh(bc4Geometry,bcMaterial);
for(i=1; i<6; i++){ 
	var clone = bc4.clone();
	clone.position.set(6.3,2.8*(i+1)+k*i-1,6.6);
    scene.add(clone); 
}
